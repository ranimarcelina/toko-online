...
<body>
	...
	<div id="wrapper">
		...
		<div class="container">
			...
			<!-- start: Table -->
                ...
                <div class="title"><h3>Form Checkout (Simulasi Midtrans)</h3></div>
                <div class="hero-unit">Harap isi form di bawah ini dengan benar sesuai identitas Anda!</div>
                <div class="hero-unit">Total Belanja Anda Rp. <?php echo abs((int)$_GET['total']); ?>,-</div> 
				<div class="hero-unit">Biaya dapat dikirimkan melalui BCA Virtual Account dengan nomor 9888-234-56347-8 atas nama Hakko Bio Richard</div>
    ...
    <input type="hidden" name="total" value="<?php echo abs((int)$_GET['total']); ?>">
      ...
      <tr>
        <td><label for="bank">Metode Pembayaran</label></td>
      ...
      <tr>
        ...
        <td><input name="total" type="text" id="total" size="200" readonly="total" value="Rp. <?php echo abs((int)$_GET['total']); ?>,-"/></td>
      </tr>
      <tr>
     	<td></td>
      	<td><input type="submit" name="finish" value="Bayar Sekarang" class="btn btn-sm btn-primary"/>&nbsp;
