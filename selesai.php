...
if (!$conn) {
  die("Connection failed: " . mysqli_connect_error());
	...
	$sql = "INSERT INTO user (id_usr, nm_usr, bank, total)VALUES (NULL, '$nm_usr', '$bank', '$total')";
	...
	<div id="wrapper">
		...
		<div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="hero-unit">Selamat Anda telah berhasil melakukan pembayaran.</div>
                 <div class="hero-unit">
    		<?php
			if($_POST['finish']){
				session_destroy();
				echo '<p>Nama Lengkap : '.$_POST['nm_usr'].'<br>';
                echo 'Pembayaran : '.$_POST['bank'].'<br>';
                echo 'Total Belanja : '.$_POST['total'].'</p>';
                echo 'Terima kasih sudah berbelanja di Toko DistroIT.';
            ...
            <tr>
      			<td></td>
        		<td><a href="cetak.php" class="btn btn-sm btn-primary">Cetak Invoice</a>
